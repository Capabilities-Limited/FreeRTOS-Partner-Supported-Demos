...
#define XPAR_AXIETHERNET_0_PHYADDR 0x1
#define XPAR_AXIETHERNET_0_DEVICE_ID 0
#define XPAR_AXIETHERNET_0_BASEADDR  0x38000000ULL
...
#define XPAR_AXIETHERNET_0_PHY_TYPE XAE_PHY_TYPE_RGMII_2_0
